...
Canonical Lane research workspace for a flagship problem in hyperbolic geometry and complex algebraic geometry:
proving algebraic degeneracy of entire curves on varieties of general type through an admissible hyperbolic closure architecture.

## Main Manuscript

- [paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md](paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md`.
...
- Manuscript target: [paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md](paper/GREEN_GRIFFITHS_LANG_CONJECTURE_PREPRINT.md)
