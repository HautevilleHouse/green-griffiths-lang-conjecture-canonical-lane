...
`sigma_hyperbolic^(raw) := hyperbolic_floor_raw - jet_loss_raw - restart_loss_raw`.
...
Main interpretation: the tracked hyperbolic defect does not consume the full closure budget.
